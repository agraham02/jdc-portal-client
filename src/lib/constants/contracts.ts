import { ContractStatus, ContractApplicationStatus } from "@/lib/types/contract";
...
export const FILE_UPLOAD_CONFIG = {
    ...
    ALLOWED_APPLICATION_EXTENSIONS: ['.pdf', '.doc', '.docx', '.txt', '.jpg', '.jpeg', '.png'] as string[],
...
export const ERROR_MESSAGES = {
    ...
    FILE_UPLOAD_ERROR: "File upload failed. Please check your files and try again.",
    VALIDATION_ERROR: "Please check your input and try again.",
    FILE_TOO_LARGE: (filename: string) => `File "${filename}" is too large. Maximum size is 10MB.`,
    ...
    TOO_MANY_FILES: (maxFiles: number) => `You can upload a maximum of ${maxFiles} files.`,
} as const;
