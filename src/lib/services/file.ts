...
export class FileService {
   ...
   */
  static async getHrDocuments(query: FileQueryDto = {}): Promise<FilesResponse> {
    const params = new URLSearchParams();
    ...
    const queryString = params.toString();
    const endpoint = queryString ? `/files/hr-documents?${queryString}` : '/files/hr-documents';
   ...
   */
  static async updateFile(id: string, updates: Partial<FileUploadDto>): Promise<UploadedFile> {
